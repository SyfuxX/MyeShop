<?php
    ...
    $result_cat = $con->query ("SELECT DISTINCT category FROM product");

    $content = '<ul class="list-group">';
    $content .= '<li class="list-group-item"><a href="'. URL . 'eshop.php">All</a></li>';
    ...
    {
        $result_prod = $con->prepare("SELECT * FROM product WHERE category = :category");
    ...
    {
        $result_prod = $con->query("SELECT * FROM product");
